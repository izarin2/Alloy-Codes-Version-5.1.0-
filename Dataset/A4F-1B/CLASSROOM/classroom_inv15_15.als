...
{#m#()  all p,q,r : Person | (p->q in Tutors or q->p in Tutors or q->r in Tutors or r->q in Tutors         or r->p in Tutors or p->r in Tutors)    and (p in Teacher or q in Teacher or r in Teacher) } --incorrect 15 
